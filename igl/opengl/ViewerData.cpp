...
IGL_INLINE void igl::opengl::ViewerData::uniform_colors_index(int i)
{
	if (i == 0)
	{
		uniform_colors(
	...
	{
		uniform_colors(
			Eigen::Vector3d(obs_ambient[0], obs_ambient[1], obs_ambient[2]),
			Eigen::Vector3d(obs_diffuse[0], obs_diffuse[1], obs_diffuse[2]),
			Eigen::Vector3d(obs_specular[0], obs_specular[1], obs_specular[2]));
	}
	else if (i == 2)
	{
		uniform_colors(
			Eigen::Vector3d(rubby_ambient[0], rubby_ambient[1], rubby_ambient[2]),
			Eigen::Vector3d(rubby_diffuse[0], rubby_diffuse[1], rubby_diffuse[2]),
			Eigen::Vector3d(rubby_specular[0], rubby_specular[1], rubby_specular[2]));
	}
	else if (i == 3)
	{
		uniform_colors(
			Eigen::Vector3d(rubber_ambient[0], rubber_ambient[1], rubber_ambient[2]),
			Eigen::Vector3d(rubber_diffuse[0], rubber_diffuse[1], rubber_diffuse[2]),
			Eigen::Vector3d(rubber_specular[0], rubber_specular[1], rubber_specular[2]));
	}
}
